...
export default function WeddingPage({ guest }: { guest: Guest }) {
  ...
  // Countdown
  useEffect(() => {
    const weddingDate = new Date("2026-07-17T18:30:00");
    ...
    <main className="min-h-screen bg-[#f5f0e8] text-[#2a2018] overflow-x-hidden">
      ...
      <section className="py-20 px-6 bg-[#ede8dc]">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <h2 className="reveal text-4xl md:text-5xl font-serif mt-4 mb-12">
            Until We Say "I Do"
          </h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
            {[
              ...
              <div
                key={label}
                className="reveal bg-white/70 border border-[#b48c3c]/25 p-8 rounded-xl shadow-sm"
              >
                <div className="text-5xl md:text-6xl font-bold text-[#c9902a]">
                  {String(value).padStart(2, "0")}
                </div>

                <div className="uppercase tracking-[0.25em] text-xs text-[#7a6a4a] mt-4">
                  {label}
                </div>
              </div>
            ))}
          ...
          <p className="reveal italic text-[#9a8a6a] mt-10 text-lg">
            July 17th, 2026 • 6:30 PM
          </p>
        </div>
      </section>
